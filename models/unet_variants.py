...
class UNet:
    ...
    def UNet(self):
        ...
        if self.problem_type == 'Classification':
            outputs = tf.keras.layers.Conv1D(self.output_nums, 1, activation=None, name="out")(deconv)
            outputs = tf.keras.activations.log_softmax(outputs)
    ...
    def UNet3P(self):
        ...
        for j in range(0, self.model_depth):
            ...
            deconv_tot = upConv_Block(deconv_tot, size=2 ** 1, interpolation_mode='nearest')
